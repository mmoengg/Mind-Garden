        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-no-repeat bg-center bg-cover bg-main">
            <div className="flex items-center flex-col  justify-between max-w-md w-full  bg-white/50 p-8 rounded-2xl border border-white text-center">
                ...
                <div className="w-full">
                    {/* 구글 로그인 버튼 */}
                    <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-white border border-white text-stone-600 text-sm font-bold py-3 px-4 rounded-full  hover:bg-white/50 transition-all active:scale-95">
                        {/* 구글 G 로고 */}
                    ...
                    <p className="text-xs text-stone-800 mt-6">로그인 시 서비스 이용약관에 동의하게 됩니다.</p>
                </div>
            </div>
        </div>
    );
