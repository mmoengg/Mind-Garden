...
const PlantCard: React.FC<PlantCardProps> = ({ plant, onWater }) => {
    ...
    return (
        <Link to={`/plants/${plant.id}`} className="group relative flex flex-col overflow-hidden rounded-3xl bg-white transition-all hover:shadow-lg border border-stone-100">
